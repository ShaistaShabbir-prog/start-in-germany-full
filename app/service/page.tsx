      ...
      <section className="sec">
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"24px",marginBottom:"60px"}}>
          {[
            ...
            {icon:"✉️",title:"Email us",desc:"Email us at shaista.s.shabbir@gmail.com — we respond to every email within 24 hours, 7 days a week.",cta:"Send an email",href:"mailto:shaista.s.shabbir@gmail.com",color:"#EFF6FF",border:"#BFDBFE",ctaColor:"btn-secondary"},
      ...
      <div style={{padding:"0 1.5rem 5rem"}}>
        <div style={{maxWidth:"1200px",margin:"0 auto",background:"linear-gradient(135deg,#0B1D3A,#1E3A5F)",borderRadius:"28px",padding:"56px",textAlign:"center"}}>
          ...
          <div style={{display:"flex",gap:"14px",justifyContent:"center",flexWrap:"wrap"}}>
            ...
            <a href="mailto:shaista.s.shabbir@gmail.com" className="btn btn-ghost-light">✉️ Email us directly</a>
          </div>
        </div>
      </div>
    </div>
