      ...
      <section className="sec">
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:"clamp(24px,4vw,64px)",alignItems:"center",marginBottom:"64px"}}>
          <div>
            ...
            <p style={{fontSize:"15px",color:"#374151",lineHeight:1.8,marginBottom:"16px"}}>By 2022, VisaVista was helping thousands of families per month. Today it covers Germany, Italy, Sweden, the UK, Canada, Australia and Spain — always with the same focus: honest, practical guidance for South Asian immigrants that actually works.</p>
