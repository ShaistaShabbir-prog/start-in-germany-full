...
<section style={{background:"#FFFBF0",borderTop:"3px solid #DC2626",padding:"4rem 0"}}>
  <div style={{...sec}}>
    ...
    <h2 style={{fontFamily:PD,fontSize:"clamp(1.6rem,3vw,2.3rem)",fontWeight:800,color:"#0B1D3A",lineHeight:1.2,marginBottom:"8px"}}>Canada Visitor Visa (TRV)</h2>
    <div style={{...bar,background:"#DC2626"}}/>
    <p style={{fontSize:"15px",color:"#6B7280",marginBottom:"2rem",maxWidth:"640px"}}>Tourism, family visits or business — up to 6 months</p>
    <div style={{display:"flex",gap:"1rem",flexWrap:"wrap",marginBottom:"2.5rem"}}>
      {[{label:"Duration",value:"Up to 6 months",icon:"📅"},{label:"Visa Fee",value:"CAD $100 + $85 biometrics",icon:"💳"},{label:"Processing",value:"3–30 weeks",icon:"⏱️"}].map(function(s){return <div key={s.label} style={{background:"#fff",border:"1.5px solid #E5E7EB",borderRadius:"12px",padding:"1rem 1.5rem",minWidth:"160px",flex:"1"}}><div style={{fontSize:"1.4rem",marginBottom:"4px"}}>{s.icon}</div><div style={{fontSize:"11px",color:"#9CA3AF",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:"2px"}}>{s.label}</div><div style={{fontSize:"15px",fontWeight:700,color:"#0B1D3A"}}>{s.value}</div></div>;})}
    </div>
    <div style={{display:"grid",gridTemplateColumns:"minmax(0,1fr) minmax(0,1fr)",gap:"2rem",alignItems:"start"}}>
      <div style={{background:"#fff",border:"1.5px solid #E5E7EB",borderRadius:"16px",padding:"1.5rem"}}>
        ...
        <ul style={{padding:0,margin:0}}>
              <CI key="0">Online application via IRCC portal</CI>
              <CI key="1">Valid Pakistani passport</CI>
              <CI key="2">IMM 5257 form</CI>
              <CI key="3">Biometrics (CAD $85 — mandatory for Pakistanis)</CI>
              <CI key="4">Bank statements (6 months, CAD $3,000+)</CI>
              <CI key="5">Employment letter or business documents</CI>
              <CI key="6">Invitation letter if visiting family in Canada</CI>
              <CI key="7">Previous travel history</CI>
              <CI key="8">Ties to Pakistan (job, family, property)</CI>
        </ul>
      </div>
      <div style={{display:"flex",flexDirection:"column",gap:"1rem"}}>
        <div style={{background:"#FEF3C7",border:"1.5px solid #FCD34D",borderRadius:"16px",padding:"1.5rem"}}>
          ...
          <p style={{fontSize:"13px",color:"#78350F",lineHeight:1.6,margin:0}}>Online applications are faster. Valid US visa holders often get faster approval. Biometrics are mandatory for Pakistanis. Show minimum CAD $3,000+ in bank.</p>
        </div>
        <a href="https://www.canada.ca/en/immigration-refugees-citizenship/services/visit-canada.html" target="_blank" rel="noopener noreferrer"
