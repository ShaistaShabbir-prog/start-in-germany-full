      ...
      <div style={s({maxWidth:"760px",margin:"0 auto",padding:"36px 24px 80px"})}>
        ...
        <div style={s({background:"#111520",border:"1px solid rgba(255,255,255,.07)",borderRadius:"12px",padding:"16px 18px"})}>
          <p style={s({fontSize:".82rem",color:"#64748b",lineHeight:1.7})}>
            This disclosure complies with FTC guidelines (USA), ASA guidelines (UK), and EU Directive 2005/29/EC on commercial practices. For questions, contact us via <a href="https://wa.me/4915906171828" style={s({color:"#FFCC02",textDecoration:"none"})}>WhatsApp</a> or <a href="https://github.com/ShaistaShabbir-prog" target="_blank" rel="noopener" style={s({color:"#FFCC02",textDecoration:"none"})}>GitHub</a>.
          </p>
        </div>
