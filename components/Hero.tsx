  ...
  return (
    <section className="relative">
      <div className="relative h-[520px] md:h-[600px]">
        <Image src="/images/hero.jpg" alt="Arriving in Germany" fill priority className="object-cover" />
      ...
      <div className="container-narrow">
        <div className="-mt-40 md:-mt-56">
          <div className="rounded-2xl bg-white/90 backdrop-blur p-8 md:p-10 shadow-md ring-1 ring-black/5">
            <h1 className="h1">Start your journey in Germany</h1>
            <p className="lead">Friendly guidance on visas, jobs, study, living and finances.</p>
